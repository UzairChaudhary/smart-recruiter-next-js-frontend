...
//     const [interviewAnswersDone, setinterviewAnswersDone] = useState(false);
...
//       const handleContinueCaptureClick = useCallback(() => {
//         setisLoading(false)
//         setCapturing(true);
...
//         mediaRecorderRef.current.start();
//       });
//       }, [webcamRef, setCapturing,transcribe, mediaRecorderRef]);
...
//       useEffect(() => {
//         if (recordedChunks.length && !capturing && completed && transcribe) {
//           handleUpload()
//         }
//         else{
//           console.log("Recording...")
//         }
//       }, [recordedChunks,capturing,completed, transcribe])
...
//           try {
//             const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/job/recognizeSpeech/${params.id}`, requestOptions);
//             const data = await response.json();
//             console.log(data); // handle response from the server
//             settranscribe(false)
...
//       useEffect(() => {
//         if (recordedChunks.length && transcribe ) {
//           speechToText()
//           handleContinueCaptureClick()
//           console.log("Speech to Text")
//         }
//         else{
//           console.log("Transcribing...")
//         }
//       }, [recordedChunks, transcribe])
