      ...
      const handleUpload = async () => {
        ...
        if (recordedChunks.length) {
          ...
          const requestOptions = {
            ...
            body: formData,
            headers: {
              "Cookie": "token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NWMwY2FjNTQzYTI2MzM2NDZhMmRjM2UiLCJpYXQiOjE3MTQ1MDI2NzZ9.YmaxUVDJ5FJcvV4PgMK5rkgpG6xBCe5qUC8q6i6mEDg"
